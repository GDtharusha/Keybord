...
public class KeyboardSettings {
    ...
    // Size defaults - MIN 200, MAX 300, DEFAULT 245
    ...
    public String getColorKeyPressed() { return prefs.getString("color_key_pressed", DEF_COLOR_KEY_PRESSED); }
    public void setColorKeyPressed(String color) { editor.putString("color_key_pressed", color).apply(); }
    ...
    public String getColorTextSpecial() { return prefs.getString("color_text_special", DEF_COLOR_TEXT_SPECIAL); }
    public void setColorTextSpecial(String color) { editor.putString("color_text_special", color).apply(); }
    ...
    public int getKeyMargin() { return prefs.getInt("key_margin", DEF_KEY_MARGIN); }
    public void setKeyMargin(int margin) { editor.putInt("key_margin", margin).apply(); }
    ...
    public int getSoundVolume() { return prefs.getInt("sound_volume", DEF_SOUND_VOLUME); }
    public void setSoundVolume(int volume) { editor.putInt("sound_volume", volume).apply(); }
    ...
    public boolean isPopupOnPress() { return prefs.getBoolean("popup_on_press", DEF_POPUP_ON_PRESS); }
    public void setPopupOnPress(boolean enabled) { editor.putBoolean("popup_on_press", enabled).apply(); }
    ...
    // Theme
    public String getCurrentTheme() { return prefs.getString("current_theme", "dark"); }
    public void setCurrentTheme(String theme) { editor.putString("current_theme", theme).apply(); }
